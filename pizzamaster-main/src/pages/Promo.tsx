          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="rounded-3xl border border-white/10 bg-card p-5">
              {/* FIX: evita que la imagen de la promo se vea entrecortada en /promo.
                 ...
                 - p-3 separa la imagen del borde para que no parezca cortada.
                 - bg-white respeta artes de producto con fondo claro. */}
              ...
              <div className="mt-4 text-4xl font-black text-emerald-400">{priceTextToday}</div>
