...
using (key = any(ARRAY[
  'promo_active','promo_badge','promo_headline','promo_subheadline','promo_body','promo_price_text','promo_detail_text',
  'promo_cta_label','promo_cta_code','promo_phone','promo_wa_number','promo_wa_message','promo_promos'
]));
