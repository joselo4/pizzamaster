      ...
      <div className='max-w-3xl mx-auto p-4'>
        ...
        <div className='mt-3 rounded-2xl overflow-hidden border border-slate-800 bg-slate-950/40'>
          <div className='h-56 bg-slate-800'>
            {(promo.hero_url || promo.image_url) ? <img src={(promo.hero_url ?? promo.image_url) as string} alt={promo.name} className='w-full h-full object-contain object-center bg-white p-2'/> : null}
          </div>
