...
const loadConfig = async () => {
  try {
    ...
    const df = Number((c as any).pedido_costo_delivery || (c as any).pedido_delivery_fee || c.costo_delivery || c.delivery_fee || 2);
    setDeliveryFee(Number.isFinite(df) ? df : 2);

    const defCat = String((c as any).pedido_default_category || 'Pizzas');
