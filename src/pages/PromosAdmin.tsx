                  ...
                  <div className='flex flex-col md:flex-row md:items-start md:justify-between gap-3'>
                    <div className='flex gap-3'>
                      <div className='w-20 h-20 rounded-lg overflow-hidden bg-slate-800 flex items-center justify-center'>
                        {(p.hero_url || p.image_url) ? <img src={(p.hero_url ?? p.image_url) as string} className='w-full h-full object-contain object-center bg-white p-2' alt={p.name} /> : <span className='text-slate-300 text-xs'>sin imagen</span>}
                      </div>
                      <div>
